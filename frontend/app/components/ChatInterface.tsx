              ...
              <form onSubmit={handleSubmit} className="relative" style={{ maxWidth: 'none', width: '100%' }}>
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-12 pl-6 py-3 text-base border border-gray-600/60 rounded-full focus:outline-none focus:border-gray-800 transition-all duration-300 font-mono"
