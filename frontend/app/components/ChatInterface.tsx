    ...
    <div className="w-full px-8 sm:px-12 lg:px-16 xl:px-20 flex flex-col" style={{ backgroundColor: '#AED4E6' }}>
              ...
              <form onSubmit={handleSubmit} className="relative" style={{ maxWidth: 'none', width: '100%' }}>
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-16 pl-6 py-3 text-base border border-gray-600/60 rounded-full focus:outline-none focus:border-gray-800 transition-all duration-300 font-mono"
          ...
          >
            ...
            <motion.div
              key={message.id}
                    ...
                    >
                      {/* Timestamp */}
                      <div className="flex-shrink-0 text-xs text-gray-700 font-mono mt-1 w-[120px] text-right">
      ...
      {messages.length > 0 && (
        <div className="flex-shrink-0 p-4 border-t border-gray-300/30" style={{ backgroundColor: '#AED4E6' }}>
            <form onSubmit={handleSubmit} className="relative w-full max-w-5xl mx-auto px-2">
            <div className="relative">
              <input
              ref={inputRef}
                type="text"
