...
import { MagnifyingGlassIcon, ArrowPathIcon, CheckCircleIcon, XCircleIcon, InformationCircleIcon } from '@heroicons/react/24/outline'
    ...
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto">
      ...
      <div className="text-center mb-6 px-4">
        ...
        <p className="text-sm font-mono" style={{ color: '#6B7280' }}>
          Search for users by describing what you need (e.g., "user with past orders", "empty cart")
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-8">
        {results.length === 0 && !isLoading && (
          ...
          >
            <InformationCircleIcon className="w-16 h-16 mx-auto mb-4" style={{ color: '#9CA3AF' }} />
            ...
            <p className="text-sm font-mono" style={{ color: '#9CA3AF' }}>
              Examples: "user with past orders", "empty cart", "onboarding viewed", "user without orders"
            </p>
          </motion.div>
        )}
              ...
              {result.userEmail && (
                <div className="flex items-start space-x-3 p-6 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-mono font-semibold text-green-800 mb-2">User Found:</p>
                    <p className="text-xl font-mono font-bold text-green-700 break-all">{result.userEmail}</p>
                  </div>
                </div>
              )}
        ...
        {isLoading && (
          ...
          >
            <ArrowPathIcon className="w-8 h-8 mx-auto mb-2 animate-spin" style={{ color: '#6B7280' }} />
            <p className="text-sm font-mono" style={{ color: '#6B7280' }}>
              Searching users...
            </p>
          </motion.div>
