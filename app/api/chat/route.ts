...
2. PLAYWRIGHT TESTS (Cook-Unity/pw-cookunity-automation)
   ...
   - Workflows: 
     * QA US - CORE UX REGRESSION (qa_us_coreux_regression.yml) - DEFAULT for "core ux" or "coreux" (when smoke is NOT mentioned)
     * QA US - CORE UX SMOKE E2E (qa_coreux_smoke_e2e.yml) - ONLY when user explicitly mentions "smoke core ux" or "core ux smoke"
