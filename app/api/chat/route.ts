...
2. PLAYWRIGHT TESTS (Cook-Unity/pw-cookunity-automation)
   ...
   - Workflows: 
     * QA US - CORE UX SMOKE E2E (qa_us_coreux_regression.yml)
     * QA US - CORE UX SMOKE E2E (qa_us_e2e_coreux_regression.yml)
...
- If user mentions "coreux" or "core ux" → use Playwright QA US - CORE UX SMOKE E2E (pw-cookunity-automation)
